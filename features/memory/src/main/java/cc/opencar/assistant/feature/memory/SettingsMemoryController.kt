...
class SettingsMemoryController(
    ...
    private val catalog: Map<String, Pair<VehicleProperty, Boolean>?> = mapOf(
        ...
        "nap_mode" to (WellKnownProperties.NAP_MODE to false),
        "space_capsule" to (WellKnownProperties.SPACE_CAPSULE to false),
        "lka" to (WellKnownProperties.LANE_KEEPING to false),
        "ldw" to (WellKnownProperties.LDW to false),
        ...
        "fcda" to (WellKnownProperties.FCDA to false),
        "dow" to (WellKnownProperties.DOW to false),
        "idas_mode" to (WellKnownProperties.IDAS_MODE to false),
        ...
        "keyless_unlock" to (WellKnownProperties.KEYLESS_UNLOCK to false),
        "twostep_unlock" to (WellKnownProperties.TWOSTEP_UNLOCK to false),
        "p_gear_unlock" to (WellKnownProperties.P_GEAR_UNLOCK to false),
        "mirror_auto_fold" to (WellKnownProperties.MIRROR_AUTO_FOLD to false),
        ...
        "exterior_light" to (WellKnownProperties.EXTERIOR_LIGHT to false),
        "home_safe_light" to (WellKnownProperties.HOME_SAFE_LIGHT to false),
        ...
        "media_volume" to (WellKnownProperties.MEDIA_VOLUME to false),
        ...
        "intelligent_steer" to (WellKnownProperties.INTELLIGENT_STEER to false),
        "hvac_auto_dry" to (WellKnownProperties.HVAC_AUTO_DRY to false),
        "hvac_rapid_cool" to (WellKnownProperties.HVAC_RAPID_COOL to false),
        "hvac_rapid_heat" to (WellKnownProperties.HVAC_RAPID_HEAT to false),
        "charge_pre_now" to (WellKnownProperties.CHARGE_PRE_NOW to false),
