...
object AntoraVhalIds {
    ...
    const val FOG_LIGHTS_SWITCH = 0x11400e12
    const val SETTING_FUNC_CAR_LOCATOR_REMINDER_MODE = 0x21407049
    const val SETTING_FUNC_LAMP_LOW_BEAM_VERTICAL_LEVEL = 0x21407220
    const val SETTING_FUNC_EASY_INGRESS_EGRESS = 0x25207227
    const val SETTING_INTELLIGENT_DRIVING_ASSISTANCE_MODE = 0x214073cd
    const val SETTING_FUNC_AUDIO_COMPENSATION_LEVEL = 0x21407416
    const val SETTING_FUNC_TRUNK_OPENING_POSITION = 0x2640725b
